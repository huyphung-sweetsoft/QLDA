	...
	public partial class TblVaiTroDuAn : ActiveRecord<TblVaiTroDuAn>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarIdVaiTroDuAn.IsPrimaryKey = true;
				colvarIdVaiTroDuAn.IsForeignKey = false;
				colvarIdVaiTroDuAn.IsReadOnly = false;
				
						colvarIdVaiTroDuAn.DefaultSetting = @"(newid())";
				colvarIdVaiTroDuAn.ForeignKeyTableName = "";
		...
		{
			get { return GetColumnValue<string>(Columns.IdVaiTro); }
		...
		public SweetSoft.QLDA.DataAccess.TblThanhVienDuAnCollection TblThanhVienDuAnRecords()
		{
			...
			{
				colTblThanhVienDuAnRecords = new SweetSoft.QLDA.DataAccess.TblThanhVienDuAnCollection().Where(TblThanhVienDuAn.Columns.IdVaiTroDuAn, IdVaiTroDuAn).Load();
		...
		void colTblThanhVienDuAnRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblThanhVienDuAnRecords[e.NewIndex].IdVaiTroDuAn = IdVaiTroDuAn;
            }
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varIdVaiTroDuAn,string varIdVaiTro,string varTenVaiTro,string varMoTa,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
		...
		/// </summary>
		public static void Update(Guid varIdVaiTroDuAn,string varIdVaiTro,string varTenVaiTro,string varMoTa,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
			TblVaiTroDuAn item = new TblVaiTroDuAn();
        ...
        public void SetPKValues()
        {
                if (colTblThanhVienDuAnRecords != null)
                {
                    ...
                    {
                        if (item.IdVaiTroDuAn == null ||item.IdVaiTroDuAn != IdVaiTroDuAn)
                        {
