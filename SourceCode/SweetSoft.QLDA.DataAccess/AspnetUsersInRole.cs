...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SweetSoft.QLDA.DataAccess.AspnetRole AspnetRole
		{
