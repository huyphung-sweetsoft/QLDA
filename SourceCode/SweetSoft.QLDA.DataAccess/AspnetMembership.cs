...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetMembership : ActiveRecord<AspnetMembership>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
