...
{
	/// <summary>
	/// Strongly-typed collection for the TblNhomTaiLieu class.
	/// </summary>
    [Serializable]
	public partial class TblNhomTaiLieuCollection : ActiveList<TblNhomTaiLieu, TblNhomTaiLieuCollection>
	{	   
		public TblNhomTaiLieuCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TblNhomTaiLieuCollection</returns>
		public TblNhomTaiLieuCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TblNhomTaiLieu o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the TblNhomTaiLieu table.
	/// </summary>
	[Serializable]
	public partial class TblNhomTaiLieu : ActiveRecord<TblNhomTaiLieu>, IActiveRecord
	{
		...
		public TblNhomTaiLieu(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TblNhomTaiLieu(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TblNhomTaiLieu(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TblNhomTaiLieu", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				colvarIdNhomTaiLieu.IsPrimaryKey = true;
				colvarIdNhomTaiLieu.IsForeignKey = false;
				colvarIdNhomTaiLieu.IsReadOnly = false;
				
						colvarIdNhomTaiLieu.DefaultSetting = @"(newid())";
				...
				DataService.Providers["DataAccessProvider"].AddSchema("TblNhomTaiLieu",schema);
			}
		}
		#endregion
		...
		public SweetSoft.QLDA.DataAccess.TblLoaiTaiLieuCollection TblLoaiTaiLieuRecords()
		{
			...
			{
				colTblLoaiTaiLieuRecords = new SweetSoft.QLDA.DataAccess.TblLoaiTaiLieuCollection().Where(TblLoaiTaiLieu.Columns.IdNhomTaiLieu, IdNhomTaiLieu).Load();
		...
		void colTblLoaiTaiLieuRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblLoaiTaiLieuRecords[e.NewIndex].IdNhomTaiLieu = IdNhomTaiLieu;
            }
		}
		#endregion
