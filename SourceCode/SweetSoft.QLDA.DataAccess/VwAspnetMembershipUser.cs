...
namespace SweetSoft.QLDA.DataAccess{
    ...
    public partial class VwAspnetMembershipUser : ReadOnlyRecord<VwAspnetMembershipUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_MembershipUsers", TableType.View, DataService.GetInstance("DataAccessProvider"));
                ...
                DataService.Providers["DataAccessProvider"].AddSchema("vw_aspnet_MembershipUsers",schema);
            }
        }
        #endregion
