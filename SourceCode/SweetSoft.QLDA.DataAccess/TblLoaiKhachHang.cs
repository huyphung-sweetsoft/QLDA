	...
	public partial class TblLoaiKhachHang : ActiveRecord<TblLoaiKhachHang>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarIdLoaiKhachHang.IsPrimaryKey = true;
				colvarIdLoaiKhachHang.IsForeignKey = false;
				colvarIdLoaiKhachHang.IsReadOnly = false;
				
						colvarIdLoaiKhachHang.DefaultSetting = @"(newid())";
				colvarIdLoaiKhachHang.ForeignKeyTableName = "";
		...
		/// </summary>
		public static void Insert(Guid varIdLoaiKhachHang,string varTenLoaiKhachHang,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
		...
		/// </summary>
		public static void Update(Guid varIdLoaiKhachHang,string varTenLoaiKhachHang,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
			TblLoaiKhachHang item = new TblLoaiKhachHang();
