...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Paths", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_Paths",schema);
			}
		}
		#endregion
		...
		private SweetSoft.QLDA.DataAccess.AspnetPersonalizationAllUserCollection colAspnetPersonalizationAllUsers;
		public SweetSoft.QLDA.DataAccess.AspnetPersonalizationAllUserCollection AspnetPersonalizationAllUsers()
		{
			if(colAspnetPersonalizationAllUsers == null)
			{
				colAspnetPersonalizationAllUsers = new SweetSoft.QLDA.DataAccess.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		...
		public SweetSoft.QLDA.DataAccess.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			...
			{
				colAspnetPersonalizationPerUserRecords = new SweetSoft.QLDA.DataAccess.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
        ...
        public void SetPKValues()
        {
                if (colAspnetPersonalizationAllUsers != null)
                {
                    foreach (SweetSoft.QLDA.DataAccess.AspnetPersonalizationAllUser item in colAspnetPersonalizationAllUsers)
                    {
