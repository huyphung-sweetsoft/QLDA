...
namespace SweetSoft.QLDA.DataAccess
{
    ...
    public partial class AspnetRoleController
    {
	    ...
	    public void Insert(Guid ApplicationId,Guid RoleId,string RoleName,string LoweredRoleName,string Description,bool IsActivated,bool IsDeleted,string CreatedBy,DateTime CreatedDate,string UpdatedBy,DateTime UpdatedDate)
	    {
	    ...
	    public void Update(Guid ApplicationId,Guid RoleId,string RoleName,string LoweredRoleName,string Description,bool IsActivated,bool IsDeleted,string CreatedBy,DateTime CreatedDate,string UpdatedBy,DateTime UpdatedDate)
	    {
		    AspnetRole item = new AspnetRole();
	        item.MarkOld();
	        item.IsLoaded = true;
