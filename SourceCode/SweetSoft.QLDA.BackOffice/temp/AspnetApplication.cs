...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		public SweetSoft.QLDA.DataAccess.AspnetMembershipCollection AspnetMembershipRecords()
		{
			...
			{
				colAspnetMembershipRecords = new SweetSoft.QLDA.DataAccess.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		...
		public SweetSoft.QLDA.DataAccess.AspnetPathCollection AspnetPaths()
		{
			...
			{
				colAspnetPaths = new SweetSoft.QLDA.DataAccess.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		...
		public SweetSoft.QLDA.DataAccess.AspnetRoleCollection AspnetRoles()
		{
			...
			{
				colAspnetRoles = new SweetSoft.QLDA.DataAccess.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		...
		public SweetSoft.QLDA.DataAccess.AspnetUserCollection AspnetUsers()
		{
			...
			{
				colAspnetUsers = new SweetSoft.QLDA.DataAccess.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
