...
namespace SweetSoft.QLDA.DataAccess
{
    ...
    public partial class AspnetPersonalizationPerUserController
    {
	    ...
	    public void Insert(Guid Id,Guid? PathId,Guid? UserId,byte[] PageSettings,DateTime LastUpdateDate)
	    {
	    ...
	    public void Update(Guid Id,Guid? PathId,Guid? UserId,byte[] PageSettings,DateTime LastUpdateDate)
	    {
		    AspnetPersonalizationPerUser item = new AspnetPersonalizationPerUser();
	        item.MarkOld();
	        item.IsLoaded = true;
