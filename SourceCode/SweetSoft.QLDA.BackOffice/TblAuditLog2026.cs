...
{
	/// <summary>
	/// Strongly-typed collection for the TblAuditLog2026 class.
	/// </summary>
    [Serializable]
	public partial class TblAuditLog2026Collection : ActiveList<TblAuditLog2026, TblAuditLog2026Collection>
	{	   
		public TblAuditLog2026Collection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TblAuditLog2026Collection</returns>
		public TblAuditLog2026Collection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TblAuditLog2026 o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the TblAuditLog_2026 table.
	/// </summary>
	[Serializable]
	public partial class TblAuditLog2026 : ActiveRecord<TblAuditLog2026>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TblAuditLog2026()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TblAuditLog2026(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TblAuditLog2026(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TblAuditLog2026(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TblAuditLog_2026", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				colvarChangedAt.IsReadOnly = false;
						...
						colvarChangedAt.DefaultSetting = @"(getutcdate())";
				...
				DataService.Providers["DataAccessProvider"].AddSchema("TblAuditLog_2026",schema);
			}
		}
		#endregion
