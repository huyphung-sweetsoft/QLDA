                    ...
                    <asp:Panel runat="server" ID="pnlSearchPopup">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label class="form-label"><%= GetResourceText(BackEndResourceKeys.MEETING_NAME) %></label>
                                <SweetSoft:ExtraTextBox runat="server" ID="txtSearchTenCuocHop" SearchColumn="TenCuocHop"></SweetSoft:ExtraTextBox>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label"><%= GetResourceText(BackEndResourceKeys.MEETING_ROOM) %></label>
                                <SweetSoft:ExtraTextBox runat="server" ID="txtSearchDiaDiem" SearchColumn="DiaDiemHop"></SweetSoft:ExtraTextBox>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><%= GetResourceText(BackEndResourceKeys.FROM_DATE) %></label>
                                <SweetSoft:ExtraTextBox runat="server" ID="txtSearchTuNgay" SearchColumn="TuNgay" TextMode="Date"></SweetSoft:ExtraTextBox>
                            </div> 
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><%= GetResourceText(BackEndResourceKeys.TO_DATE) %></label>
                                <SweetSoft:ExtraTextBox runat="server" ID="txtSearchDenNgay" SearchColumn="DenNgay" TextMode="Date"></SweetSoft:ExtraTextBox>
                            </div>
                        </div>
                    </asp:Panel>
                </ContentTemplate>
