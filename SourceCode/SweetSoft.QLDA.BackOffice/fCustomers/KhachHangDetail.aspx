...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="server">
    <asp:UpdatePanel runat="server" ID="upCustomerDetail" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="row">
                <div class="col-12">
                    <div class="card p-3 min-vh-100">
                        ...
                        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-start gap-3 mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <asp:UpdatePanel runat="server" ID="upEditCustomer" UpdateMode="Conditional">
                                   <ContentTemplate>
                                        <asp:LinkButton runat="server" ID="lbtEditCustomer" CssClass="btn btn-outline-secondary" OnClick="lbtEditCustomer_Click" CausesValidation="false">
