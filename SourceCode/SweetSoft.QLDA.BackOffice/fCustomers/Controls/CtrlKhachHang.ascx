    ...
    <div class="d-flex flex-column flex-xl-row gap-3">
        ...
        <div runat="server" id="tagOther" visible="false" class="d-flex justify-content-end gap-3 w-full flex-wrap">
             <asp:UpdatePanel runat="server" ID="pnlButtons" UpdateMode="Conditional">
                 <ContentTemplate>
                     <div class="d-flex">
                         <SweetSoft:ExtraButton runat="server" ID="btnQuanLyLoaiDuAn" OnClick="btnQuanLyLoaiKhachHang_Click" CssClass="waves-effect waves-light font-mobile-small me-2" ButtonStyle="Secondary"><i class="fas fa-cogs"></i> Quản lý loại khách hàng</SweetSoft:ExtraButton>
