<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterTemplate.Master" AutoEventWireup="true"
    CodeBehind="KhachHangList.aspx.cs" Inherits="SweetSoft.QLDA.BackOffice.fCustomers.KhachHangList" %>

    <%@ Import Namespace="SweetSoft.QLDA.Core.Managers" %>
        <%@ Import Namespace="SweetSoft.QLDA.Core.ResourceTexts" %>
            <%@ Import Namespace="SweetSoft.QLDA.Core.EnumHelper.Defines" %>
                <%@ Register Src="~/fCustomers/Controls/CtrlKhachHang.ascx" TagPrefix="SweetSoft"
                    TagName="CtrlKhachHang" %>
