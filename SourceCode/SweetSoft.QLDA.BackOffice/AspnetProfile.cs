...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetProfile : ActiveRecord<AspnetProfile>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Profile", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_Profile",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varUserId,string varPropertyNames,string varPropertyValuesString,byte[] varPropertyValuesBinary,DateTime varLastUpdateDate)
		{
		...
		/// </summary>
		public static void Update(Guid varUserId,string varPropertyNames,string varPropertyValuesString,byte[] varPropertyValuesBinary,DateTime varLastUpdateDate)
		{
			AspnetProfile item = new AspnetProfile();
