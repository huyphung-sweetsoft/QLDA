	...
	public partial class TblLoaiDuAn : ActiveRecord<TblLoaiDuAn>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarMaLoaiDuAn.IsPrimaryKey = true;
				colvarMaLoaiDuAn.IsForeignKey = false;
				colvarMaLoaiDuAn.IsReadOnly = false;
				
						colvarMaLoaiDuAn.DefaultSetting = @"(newid())";
				colvarMaLoaiDuAn.ForeignKeyTableName = "";
		...
		public SweetSoft.QLDA.DataAccess.TblDuAnCollection TblDuAnRecords()
		{
			...
			{
				colTblDuAnRecords = new SweetSoft.QLDA.DataAccess.TblDuAnCollection().Where(TblDuAn.Columns.MaLoaiDuAn, MaLoaiDuAn).Load();
		...
		void colTblDuAnRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblDuAnRecords[e.NewIndex].MaLoaiDuAn = MaLoaiDuAn;
            }
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varMaLoaiDuAn,string varTenLoaiDuAn,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
		...
		/// </summary>
		public static void Update(Guid varMaLoaiDuAn,string varTenLoaiDuAn,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
			TblLoaiDuAn item = new TblLoaiDuAn();
        ...
        public void SetPKValues()
        {
                if (colTblDuAnRecords != null)
                {
                    ...
                    {
                        if (item.MaLoaiDuAn != MaLoaiDuAn)
                        {
                            item.MaLoaiDuAn = MaLoaiDuAn;
                        }
                    }
               }
		}
