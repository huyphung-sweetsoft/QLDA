...
namespace SweetSoft.QLDA.BackOffice.fUsers
{
    public partial class UserList : BaseAdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CtrlUserDetail1.SavedHandlerCallback += (s, ev) => { CtrlUsers1.Rebind(); };
                ...
                Navigation1.keyValuePairUrls = new Dictionary<string, string>()
        {
            {RewriteURLHelper.Users, GetResourceText(BackEndResourceKeys.USER_LIST) }
                ...
                // ÉP CHẾ ĐỘ: TÀI KHOẢN HỆ THỐNG
                CtrlUserDetail1.CurrentMode = UserPopupMode.SystemUser;
        ...
        private void EditUserAction(object sender, EventArgs e)
        {
            ...
            {
                // Trỏ thẳng sang hàm Edit của Control
        ...
        //    ScriptManager.RegisterStartupScript(this.Page, GetType(), "ToggleUI", script, true);
        //}
        //private void EditUserAction(object sender, EventArgs e)
        //{
        //    if (sender == null)
        ...
        //        {
        //            SendMail(new { User = user, Password = password }, EventArgs.Empty);//Gọi xuống cái sendmail để khi đổi mật khẩu trên cái text thì nó sẽ đổi
        //        }
        //        if (isAdd)
