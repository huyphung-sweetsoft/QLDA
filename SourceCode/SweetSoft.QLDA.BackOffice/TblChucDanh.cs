	...
	public partial class TblChucDanh : ActiveRecord<TblChucDanh>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarMaChucDanh.IsNullable = false;
				colvarMaChucDanh.IsPrimaryKey = true;
				colvarMaChucDanh.IsForeignKey = false;
				colvarMaChucDanh.IsReadOnly = false;
				
						colvarMaChucDanh.DefaultSetting = @"(newid())";
		...
		public SweetSoft.QLDA.DataAccess.TblNhanVienCollection TblNhanVienRecords()
		{
			...
			{
				colTblNhanVienRecords = new SweetSoft.QLDA.DataAccess.TblNhanVienCollection().Where(TblNhanVien.Columns.MaChucDanh, MaChucDanh).Load();
		...
		void colTblNhanVienRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblNhanVienRecords[e.NewIndex].MaChucDanh = MaChucDanh;
            }
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varMaChucDanh,Guid? varMaPhongBan,string varTenChucDanh,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
		...
		/// </summary>
		public static void Update(Guid varMaChucDanh,Guid? varMaPhongBan,string varTenChucDanh,string varMoTa,int varThuTuHienThi,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
			TblChucDanh item = new TblChucDanh();
        ...
        public void SetPKValues()
        {
                if (colTblNhanVienRecords != null)
                {
                    ...
                    {
                        if (item.MaChucDanh == null ||item.MaChucDanh != MaChucDanh)
                        {
