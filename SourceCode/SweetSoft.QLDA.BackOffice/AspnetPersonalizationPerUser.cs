...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetPersonalizationPerUser : ActiveRecord<AspnetPersonalizationPerUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationPerUser", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				colvarLastUpdateDate.DefaultSetting = @"";
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_PersonalizationPerUser",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SweetSoft.QLDA.DataAccess.AspnetPath AspnetPath
		{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid? varPathId,Guid? varUserId,byte[] varPageSettings,DateTime varLastUpdateDate)
		{
			...
			item.LastUpdateDate = varLastUpdateDate;
		...
		/// </summary>
		public static void Update(Guid varId,Guid? varPathId,Guid? varUserId,byte[] varPageSettings,DateTime varLastUpdateDate)
		{
			AspnetPersonalizationPerUser item = new AspnetPersonalizationPerUser();
