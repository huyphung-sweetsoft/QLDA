<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterTemplate.Master" AutoEventWireup="true" CodeBehind="NotFound.aspx.cs" Inherits="SweetSoft.QLDA.BackOffice.NotFound" %>
        ...
        <div class="col-lg-12">
            <div class="card min-h-sreen p-2">
                <div class="text-center mb-5">
                    ...
                    <h4 class="text-uppercase"><%= GetResourceText(BackEndResourceKeys.DATA_NOT_FOUND) %></h4>
