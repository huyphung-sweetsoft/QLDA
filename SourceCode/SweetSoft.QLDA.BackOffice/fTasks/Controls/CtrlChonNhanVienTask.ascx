...
<SweetSoft:ExtraModal runat="server" ID="mdlTaskMemberPicker" Type="Primary" DefaultButton="btnConfirmTaskAssign">
    ...
    <FooterTemplate>
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <SweetSoft:ExtraButton runat="server" ID="btnConfirmTaskAssign" CssClass="waves-effect waves-light" ButtonStyle="Primary" ButtonIcon="Check" IsPace="true" OnClick="btnConfirmTaskAssign_Click">
