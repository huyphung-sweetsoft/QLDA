        ...
        <div class="modal-card" style="width: 650px; max-width: 95vw;">
            <div class="modal-header-sweet">
                <h3>
                    ...
                    <span id="modalTitle"><%= GetResourceText(BackEndResourceKeys.SCHEDULE_DETAILS) %></span>
                </h3>
            ...
            <div class="p-3 border-top bg-light d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-secondary fw-bold" onclick="closeDayModal()"><%= GetResourceText(BackEndResourceKeys.CLOSE) %></button>
            </div>
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpBottomScript" runat="server">
    <script type="text/javascript">
        ...
        var calLang = {
            ...
            busy: '<%= GetResourceText(BackEndResourceKeys.WORKING) %>', // Hoặc HAS_TASK
            ...
            holidayTitle: '<%= GetResourceText(BackEndResourceKeys.HOLIDAY) %>',
            otherProject: '<%= GetResourceText(BackEndResourceKeys.OTHER_PROJECT_UNIDENTIFIED) %>',
            detailTitle: '<%= GetResourceText(BackEndResourceKeys.SCHEDULE_DETAILS) %>',
            day: '<%= GetResourceText(BackEndResourceKeys.DAY) %>'
        };
