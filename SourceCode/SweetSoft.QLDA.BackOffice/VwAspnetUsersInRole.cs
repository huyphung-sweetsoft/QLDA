...
namespace SweetSoft.QLDA.DataAccess{
    ...
    public partial class VwAspnetUsersInRole : ReadOnlyRecord<VwAspnetUsersInRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_UsersInRoles", TableType.View, DataService.GetInstance("DataAccessProvider"));
                ...
                DataService.Providers["DataAccessProvider"].AddSchema("vw_aspnet_UsersInRoles",schema);
            }
        }
        #endregion
