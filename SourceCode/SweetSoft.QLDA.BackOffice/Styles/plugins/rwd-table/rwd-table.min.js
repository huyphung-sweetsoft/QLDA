...
! function (d) {
    ...
    a.DEFAULTS = {
        ...
        })), this.options.addDisplayAllBtn && (this.$displayAllBtn = d('<button type="button" class="btn btn-default">' + this.options.i18n.displayAll + "</button>"), this.$dropdownGroup.append(this.$displayAllBtn), this.$table.hasClass("display-all") && this.$displayAllBtn.addClass("btn-active"), this.$displayAllBtn.click(function () {
        ...
        this.$displayAllBtn && this.$displayAllBtn.toggleClass("btn-active", t), this.$table.toggleClass("display-all", t), this.$tableClone && this.$tableClone.toggleClass("display-all", t), i && d(window).trigger(this.displayAllTrigger)
        ...
        var t, i = this,
            ...
            l = 0;
        //----------------------
        //console.log(s, n, i.$stickyTableHeader.height());
        var offsetTop = $('.table-extra')[0].getBoundingClientRect().top;
        ...
        if (t = this.options.mainContainer === window ? o < a && a < o + i.$table.height() : o <= 0 && -o < i.$table.height(), i.useFixedSolution) {
            if (i.$stickyTableHeader.scrollLeft(i.$tableScrollWrapper.scrollLeft()), e = l - 1, this.options.mainContainer === window && s < a - o ? (e -= a - o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : this.options.mainContainer !== window && s < -o ? (e -= -o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : i.$stickyTableHeader.removeClass("border-radius-fix"), t) return void i.$stickyTableHeader.css({
                opacity: 1,
                visibility: "visible",
                top: (e + parseFloat(offsetTop)) + "px",
                width: i.$tableScrollWrapper.innerWidth() + "px",
                height: i.$thead.height() + 2 + "px"
            });
        ...
        n.$hdrCells.each(function (t) {
            ...
            if (e || (e = n.idPrefix + t, i.prop("id", e)), "" === o && (o = i.attr("data-col-name")), i.is("[data-priority]") && -1 !== i.data("priority")) {
                ...
                n.$dropdownContainer.append(a), a.click(function () {
                    ...
                    n.$table.hasClass("display-all") && (d.proxy(n.preserveDisplayAll(), n), n.$table.removeClass("display-all"), n.$tableClone && n.$tableClone.removeClass("display-all"), n.$displayAllBtn.removeClass("btn-active")), i.each(function () {
                        var t = d(this);
                        if (e.is(":checked")) {
