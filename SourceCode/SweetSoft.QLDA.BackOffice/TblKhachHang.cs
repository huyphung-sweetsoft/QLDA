	...
	public partial class TblKhachHang : ActiveRecord<TblKhachHang>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarMaKhachHang.IsPrimaryKey = true;
				colvarMaKhachHang.IsForeignKey = false;
				colvarMaKhachHang.IsReadOnly = false;
				
						colvarMaKhachHang.DefaultSetting = @"(newid())";
				...
				colvarMaLoaiKhachHang.IsPrimaryKey = false;
				colvarMaLoaiKhachHang.IsForeignKey = true;
				colvarMaLoaiKhachHang.IsReadOnly = false;
				colvarMaLoaiKhachHang.DefaultSetting = @"";
				
					colvarMaLoaiKhachHang.ForeignKeyTableName = "TblLoaiKhachHang";
				...
				colvarMaSoThue.DataType = DbType.AnsiString;
				colvarMaSoThue.MaxLength = 50;
		...
		public SweetSoft.QLDA.DataAccess.TblDuAnCollection TblDuAnRecords()
		{
			...
			{
				colTblDuAnRecords = new SweetSoft.QLDA.DataAccess.TblDuAnCollection().Where(TblDuAn.Columns.MaKhachHang, MaKhachHang).Load();
		...
		void colTblDuAnRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblDuAnRecords[e.NewIndex].MaKhachHang = MaKhachHang;
            }
		}
		...
		public SweetSoft.QLDA.DataAccess.TblHopDongThucHienCollection TblHopDongThucHienRecords()
		{
			...
			{
				colTblHopDongThucHienRecords = new SweetSoft.QLDA.DataAccess.TblHopDongThucHienCollection().Where(TblHopDongThucHien.Columns.MaKhachHang, MaKhachHang).Load();
		...
		void colTblHopDongThucHienRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            ...
            {
		        // Set foreign key value
		        colTblHopDongThucHienRecords[e.NewIndex].MaKhachHang = MaKhachHang;
            }
		}
		#endregion
		...
		{
			get { return SweetSoft.QLDA.DataAccess.TblLoaiKhachHang.FetchByID(this.MaLoaiKhachHang); }
			set { SetColumnValue("MaLoaiKhachHang", value.MaLoaiKhachHang); }
		}
		...
		/// </summary>
		public static void Update(Guid varMaKhachHang,string varTenKhachHang,Guid varMaLoaiKhachHang,string varMaSoThue,string varSoDienThoai,string varThuDienTu,string varDiaChi,string varTenNguoiDaiDien,string varTenNguoiLienHe,string varDienThoaiLienHe,string varThuDienTuLienHe,string varGhiChu,bool varKichHoat,bool varDaXoa,string varNguoiTao,DateTime varNgayTao,string varNguoiCapNhat,DateTime? varNgayCapNhat)
		{
			TblKhachHang item = new TblKhachHang();
