...
namespace SweetSoft.QLDA.DataAccess{
    ...
    public partial class VwAspnetRole : ReadOnlyRecord<VwAspnetRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Roles", TableType.View, DataService.GetInstance("DataAccessProvider"));
                ...
                DataService.Providers["DataAccessProvider"].AddSchema("vw_aspnet_Roles",schema);
            }
        }
        #endregion
