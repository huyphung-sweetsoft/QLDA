...
namespace SweetSoft.QLDA.DataAccess
{
	...
	public partial class AspnetPersonalizationAllUser : ActiveRecord<AspnetPersonalizationAllUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varPathId,byte[] varPageSettings,DateTime varLastUpdateDate)
		{
		...
		/// </summary>
		public static void Update(Guid varPathId,byte[] varPageSettings,DateTime varLastUpdateDate)
		{
			AspnetPersonalizationAllUser item = new AspnetPersonalizationAllUser();
