...
namespace SweetSoft.QLDA.DataAccess
{
    ...
    public partial class AspnetProfileController
    {
	    ...
	    public void Insert(Guid UserId,string PropertyNames,string PropertyValuesString,byte[] PropertyValuesBinary,DateTime LastUpdateDate)
	    {
	    ...
	    public void Update(Guid UserId,string PropertyNames,string PropertyValuesString,byte[] PropertyValuesBinary,DateTime LastUpdateDate)
	    {
		    AspnetProfile item = new AspnetProfile();
	        item.MarkOld();
	        item.IsLoaded = true;
