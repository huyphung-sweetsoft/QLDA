...
{
	/// <summary>
	/// Strongly-typed collection for the TblProjectType class.
	/// </summary>
    [Serializable]
	public partial class TblProjectTypeCollection : ActiveList<TblProjectType, TblProjectTypeCollection>
	{	   
		public TblProjectTypeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TblProjectTypeCollection</returns>
		public TblProjectTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TblProjectType o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the TblProjectType table.
	/// </summary>
	[Serializable]
	public partial class TblProjectType : ActiveRecord<TblProjectType>, IActiveRecord
	{
		...
		public TblProjectType(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TblProjectType(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TblProjectType(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TblProjectType", TableType.Table, DataService.GetInstance("DataAccessProvider"));
				...
				DataService.Providers["DataAccessProvider"].AddSchema("TblProjectType",schema);
			}
		}
		#endregion
		...
		public SweetSoft.QLDA.DataAccess.TblProjectCollection TblProjectRecords()
		{
			...
			{
				colTblProjectRecords = new SweetSoft.QLDA.DataAccess.TblProjectCollection().Where(TblProject.Columns.ProjectTypeId, Id).Load();
		...
		void colTblProjectRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colTblProjectRecords[e.NewIndex].ProjectTypeId = Id;
            }
		}
		#endregion
        ...
        public void SetPKValues()
        {
                if (colTblProjectRecords != null)
                {
                    ...
                    {
                        if (item.ProjectTypeId != Id)
                        {
                            item.ProjectTypeId = Id;
                        }
                    }
               }
		}
