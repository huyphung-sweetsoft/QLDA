                        ...
                        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-start gap-3 mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                <span class="badge rounded-pill bg-light text-secondary border px-3 py-2">
                                    <asp:Label runat="server" ID="lblTrangThaiHead"></asp:Label>
                                </span>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <asp:UpdatePanel runat="server" ID="upEditProject" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:LinkButton runat="server" ID="lbtEditProject" CssClass="btn btn-outline-secondary" OnClick="lbtEditProject_Click" CausesValidation="false">
